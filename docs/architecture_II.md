...
Wenn du möchtest, kann ich dir auch gleich:

* die ersten **leeren Datei-Skelette** erstellen
* ein **Blockdiagramm** der Firmware zeichnen
* oder ein **komplettes Basisprojekt** generieren, das sofort kompilierbar ist.
